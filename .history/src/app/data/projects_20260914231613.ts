...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Vistara",
    description:
      " ON GOING PROJECT as major project for my portfolio. Full-stack property listing platform with JWT/Auth.js authentication and dynamic search, connected to a MongoDB-backed user-management service and containerized with Docker.",
