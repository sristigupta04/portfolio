        ...
        className="portfolio-section contact-section">
            <div className="portfolio-container">
                ...
                <div className="contact-links">
                 ...
                 <a href="https://www.https://www.linkedin.com/in/sristi-gupta-39528032b/" target="_blank" rel="noopener noreferrer" className="contact-link">
                        <span>LinkedIn</span>
                        <span aria-hidden="true" className="contact-link-separator">|</span>
                    </a>
                    <a href="https://github.com/sristigupta04" target="_blank" rel="noopener noreferrer" className="contact-link">
                        <span>GitHub</span>
                    </a>
"
                </div>
